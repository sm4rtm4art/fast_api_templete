...
@pytest.mark.skipif(not GOOGLE_API_MOCK_AVAILABLE, 
                    reason="googleapiclient.http mock not available")
class TestGCPWithGoogleAPIMock:
    ...
    def test_storage_operations(self, gcp_service):
        ...
        with patch('googleapiclient.discovery.build') as mock_build:
            ...
            content = storage_client.objects().get_media(
                bucket=bucket_name,
                object=object_name
            ).execute()
    ...
    def test_pubsub_operations(self, gcp_service):
        ...
        with patch('google.cloud.pubsub_v1.PublisherClient') as mock_publisher_class:
            ...
            with patch.object(gcp_service, 'get_queue_client', 
