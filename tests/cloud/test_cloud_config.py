    ...
    return MockSettings(
        {
            "cloud": {
                ...
                "gcp": {
                    ...
                    "memorystore": {"instance": "test-instance", "project_id": "test-project"},
    ...
    return MockSettings(
        {
            "cloud": {
                ...
                "azure": {
                    ...
                    "redis": {"host": "test-host", "port": 6380},
    ...
    return MockSettings(
        {
            "cloud": {
                ...
                "custom": {
                    ...
                    "cache": {"type": "redis", "host": "redis.local", "port": 6379},
                    "queue": {"type": "rabbitmq", "host": "rabbitmq.local"},
                },
            }
        }
    )
