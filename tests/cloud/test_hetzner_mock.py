        ...
        self._settings = {
            "cloud": {
                ...
                "hetzner": {
                    ...
                    "storage": {"box_id": "test-box-id", "subdomain": "test-subdomain"},
                    "cache": {"host": "redis.example.com", "port": 6379, "password": "test-password"},
                    "queue": {
...
class TestHetznerMock:
    ...
    def test_server_operations(self, hetzner_service):
        ...
        with requests_mock.Mocker() as m:
            ...
            m.post(
                ...
                json={
                    "server": {
                        ...
                        "datacenter": {"id": 1, "name": "fsn1-dc14", "location": {"id": 1, "name": "fsn1"}},
                        "public_net": {
            ...
            m.get(
                "https://api.hetzner.cloud/v1/servers",
                json={"servers": [{"id": 42, "name": "test-server", "status": "running"}]},
            )

            # Mock server deletion
            m.delete("https://api.hetzner.cloud/v1/servers/42", status_code=204)
            ...
            response = client.post(
                server_url,
                json={"name": "test-server", "server_type": "cx11", "datacenter": "fsn1-dc14", "image": "ubuntu-20.04"},
            )
    ...
    def test_storage_box_operations(self, hetzner_service):
        ...
        with requests_mock.Mocker() as m:
            ...
            # Mock file download
            m.get(test_file, text="Hello, Hetzner Storage Box!", status_code=200)
