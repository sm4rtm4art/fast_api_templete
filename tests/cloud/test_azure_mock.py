"""Test Azure cloud services using mock approaches.

This module demonstrates how to mock Azure services for testing
without incurring actual Azure costs.
"""
...
def azure_config() -> TestCloudConfig:
    ...
    return TestCloudConfig(TestSettings())  # type: ignore
...
class TestAzureMock:
    ...
    def test_blob_storage_error_handling(
        ...
        # Create mock transport with configurable status code
        mock_transport = AzureMockTransport(status_codes={f"/{test_container_name}": status_code})
